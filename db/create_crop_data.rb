...
crops = { crops: [
  {
    ...
    description: 'Tomato is the edible berry of the plant Solanum lycopersicum. The species originated in western South America and Central America. Its wild ancestors were only the size of peas.',
  ...
  },
  {
    ...
    max_hardiness_zone: 11,
    min_hardiness_zone: 2,
    sowing_months: 'March, April, May, June, July',
    spacing_in_cm: 10,
    planting_depth_in_cm: 2,
    climber: false,
    sun_exposure: 'Full Sun',
  ...
  },
  {
    ...
    max_hardiness_zone: 11,
    min_hardiness_zone: 2,
    sowing_months: 'March, April, August, September',
    spacing_in_cm: 5,
    planting_depth_in_cm: 2,
    climber: false,
    sun_exposure: 'Full Sun',
  ...
  },
  {
    ...
    max_hardiness_zone: 10,
    min_hardiness_zone: 4,
    sowing_months: 'April, May, September, October, November',
    spacing_in_cm: 10,
    planting_depth_in_cm: 5,
    climber: false,
    sun_exposure: 'Full Sun',
  ...
  },
  {
    ...
    max_hardiness_zone: 9,
    min_hardiness_zone: 2,
    sowing_months: 'February, March, April, August, September, October',
    spacing_in_cm: 10,
    planting_depth_in_cm: 2,
    climber: false,
    sun_exposure: 'Full Sun',
  ...
  },
  {
    ...
    max_hardiness_zone: 10,
    min_hardiness_zone: 5,
    sowing_months: 'April, May, August, September',
    spacing_in_cm: 10,
    planting_depth_in_cm: 1,
    climber: false,
    sun_exposure: 'Full Sun',
  ...
  },
  {
    ...
    description: 'Blueberries are the with blue or purple berries of the Cyanococcus plants. They are native to North America, and commonly divided into wild (lowbush) and cultivated (highbush) varieties.',
